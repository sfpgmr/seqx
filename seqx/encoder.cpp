...
namespace sf 
{
  namespace encoder {
    ...
    encoder_::encoder_() : close_event_(CreateEvent(NULL, FALSE, FALSE, NULL))
    {
    ...
    void encoder_::start()
    {
      ...
      THROW_IF_ERR(session_->Start(&GUID_NULL, &varStart));
    }
    
   HRESULT encoder_::Invoke(IMFAsyncResult *pResult)
    {
      ...
      try {
        ...
        THROW_IF_ERR(session_->EndGetEvent(pResult, pEvent.GetAddressOf()));
    ...
    void encoder_::HandleEvent(UINT_PTR pEventPtr)
    {
